...
@AllArgsConstructor
@ApiModel(value = "PrivateTaskResponse")
public class PrivateTaskResponse {
    ...
    public static PrivateTaskResponse fromTask(Task task) {
        return PrivateTaskResponse.builder()
                .id(task.getId())
                .name(task.getName())
