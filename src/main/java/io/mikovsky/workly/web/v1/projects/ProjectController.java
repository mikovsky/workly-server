...
public class ProjectController {
    ...
    public ProjectResponse updateProject(@PathVariable Long projectId, @Valid @RequestBody UpdateProjectRequest request, Principal principal) {
        User user = User.fromPrincipal(principal);
    ...
    public ProjectMemberResponse addMemberToProject(@PathVariable Long projectId, @Valid @RequestBody AddMemberRequest request, Principal principal) {
        User user = User.fromPrincipal(principal);
    ...
    public ResponseEntity<Void> deleteProject(@PathVariable Long projectId, @PathVariable Long memberId, Principal principal) {
        User user = User.fromPrincipal(principal);
